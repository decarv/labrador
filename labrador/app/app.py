...
async def neural_search(request: Request) -> HTTPResponse:
    ...
    try:
        ...
        app.ctx.adb.query_times_write(end - start, "neural_retriever", query_id)
...
async def keyword_search(request: Request) -> HTTPResponse:
    ...
    try:
        ...
        app.ctx.adb.query_times_write(end - start, "keyword_retriever", query_id)
...
async def repository_search(request: Request) -> HTTPResponse:
    ...
    try:
        ...
        app.ctx.adb.query_times_write(end - start, "repository_retriever", query_id)
